...
///    clamping behavior.
class PowerListRefreshPhysics extends ScrollPhysics {
  /// 任务状态
  ...
  @override
  PowerListRefreshPhysics applyTo(ScrollPhysics? ancestor) {
    return PowerListRefreshPhysics(
  ...
  /// Whether to allow Bottom out of bounds (the list is not full)
  ...
  double applyBoundaryConditions(ScrollMetrics position, double value) {
    ...
    if (!bouncingNotifier.value.bottom && value - position.maxScrollExtent > 0.0 && !bottomOverScroll) {
      // 防止越界超过footer高度
      return value - position.maxScrollExtent;
    }
    return 0.0;
